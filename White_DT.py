...
m_tree = m[['State', 'White_June15', 'Reopening', 'Mask', 'over_100']]
...
m_tree['White_June15']=le.fit_transform(m_tree['White_June15'])
...
data_feature_names = ['State', 'White_June15', 'Reopening', 'Mask']
