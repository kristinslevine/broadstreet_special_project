...
m_tree = m[['State', 'NHPI_June15', 'Reopening', 'Mask', 'over_100']]
...
m_tree['NHPI_June15']=le.fit_transform(m_tree['NHPI_June15'])
...
data_feature_names = ['State', 'NHPI_June15', 'Reopening', 'Mask']
