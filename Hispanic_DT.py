...
m = pd.read_csv('hispanic_data.csv')
desired_width=320
...
m_tree = m[['State', 'Hispanic_June15', 'Reopening', 'Mask', 'over_100']]
...
m_tree['Hispanic_June15']=le.fit_transform(m_tree['Hispanic_June15'])
...
data_feature_names = ['State', 'Hispanic_June15', 'Reopening', 'Mask']
